...
class Diamond(models.Model):
    ...
    report_number = models.CharField(max_length=100, unique=True, blank=False, null=False)
    ...
    color = models.CharField(max_length=10, blank=True, null=True, choices=COLOUR)
    clarity = models.CharField(max_length=10, blank=True, null=True, choices=CLARITY)
    rap_rate = models.IntegerField(blank=False, null=False)
    discount_percentage = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    ...
    cut = models.CharField(max_length=20, blank=True, null=True, choices=CUT)
    polish = models.CharField(max_length=20, blank=True, null=True, choices=POLISH)
    symmetry = models.CharField(max_length=20, blank=True, null=True, choices=SYMMETRY)
    ...
    table_percentage = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    depth_percentage = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    crown_angle = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    crown_height_percentage = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    pavilion_angle = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    pavilion_depth = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
